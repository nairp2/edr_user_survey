...
with col_c:
        logo_left, logo_right = st.columns([1, 4])
        with logo_right:
...
# ----------------------------------------------------------------------
if page == "📝 Take Survey":
    st.markdown("<h1 style='text-align:center; font-size: 36px'> Cyber Risk Management (CRM) Tableau Dashboard User Survey</h1>", unsafe_allow_html=True)
    st.markdown("""
        <div style="
            color:#595959;
            font-size:15px;
